...
import quasarzone_cleaner.dcinside_cleaner
    ...
    def aggregatePosts(self, gno: str, post_type: str, signal,count) -> None:
        ...
        if post_type == 'posting':
            ...
            while True:
                ...
                dabate_div = soup.find('div', class_='dabate-type-list')
                if dabate_div == None:
                        ...
                        while True:
                            ...
                            if len(value['comm_list']) > 0:
                                ...
                                for coid in match_ids:
                                    ...
                                    payload = {'_token': self.token, '_method': 'put',  'writeId': number,'commentId' : coid ,'commentSort' : 'old' ,'requestUri' :f'{bbsurl}/views/'+number+'?'+str(firstpage) ,'page' : firstpage, 'content': 'del'}
